...
#
#     try:
#         doctor = DoctorUser.objects.get(pk=doctor_id)
...
#     doctor = get_object_or_404(DoctorUser, pk=doctor_id)    # 404 if doctor doesn't exist
#
...
#     doctor = get_object_or_404(DoctorUser, pk=doctor_id)
